...
* Scottish Index of Multiple Deprivation (SIMD) available here -> [ShinySIMD](https://github.com/chuecadelc/ShinySIMD)
  
* British Election Study (BES) available here -> [ShinyBES](https://github.com/chuecadelc/BESShiny)

Then, in 2022/2023 as a part-time research assistant School of Social and Political Sciences at Glasgow University (once more), I co-designed and coded the DEMED research group [here](https://www.gla.ac.uk/research/az/democracyresearch/). While I designed and coded the original prototype, the most recent version was developed in collaboration with Dr. Wooseok Kim. It can be found [here](https://shiny.cent.gla.ac.uk/).

* Democracy under Threat: How Education can Save it (DEMED) available -> [ShinyDEMED](https://github.com/chuecadelc/DEMED-Shiny-App)

While at Durham University working as a research associate in computational social science (2023-2026), I have designed and coded an RShiny app to showcase our taxonomy of network generator papers and host such database. The app includes summary statistics, tables and visualisations (histograms, heatmaps and wordclouds). 

* (Designing) Realistic Artificial Social Networks (RASN) available late Spring 2026 as our preparation for submission of the corresponding paper finalises.
